...
const config = {
	...
	chapters: [
		...
		},
		{
			...
			title: "",
			description:
				'Just south there at 9:26 p.m., multiple bike patrol officers can be seen <span class="highlighter yellow-highlighter">running towards a protester</span> who was throwing things at the police.',
			location: {
